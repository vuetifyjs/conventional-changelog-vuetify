...
describe('vuetify preset', function () {
  it('should work if there is no semver tag', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        ...
        expect(chunk).to.include(', closes [#1](https://github.com/vuetifyjs/conventional-changelog-vuetify/issues/1) [#2](https://github.com/vuetifyjs/conventional-changelog-vuetify/issues/2)')
  ...
  it('should replace #[0-9]+ with GitHub issue URL', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        chunk = chunk.toString()
        expect(chunk).to.include('[#133](https://github.com/vuetifyjs/conventional-changelog-vuetify/issues/133)')
        done()
      }))
  })
  ...
  it('should remove the issues that already appear in the subject', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        chunk = chunk.toString()
        expect(chunk).to.include('[#88](https://github.com/vuetifyjs/conventional-changelog-vuetify/issues/88)')
        expect(chunk).to.not.include('closes [#88](https://github.com/vuetifyjs/conventional-changelog-vuetify/issues/88)')
        done()
      }))
  })
